    ...
    <div className="space-y-8">
       <header className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
        ...
        <div className="space-y-3 min-w-0">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-headline tracking-tighter break-words [overflow-wrap:anywhere]">
            {playlist.name}
          </h1>
          {playlist.description && <p className="text-muted-foreground text-sm break-words [overflow-wrap:anywhere]">{playlist.description}</p>}
